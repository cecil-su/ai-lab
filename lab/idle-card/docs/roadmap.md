...
1. **数值平衡** — 关卡难度曲线、成长曲线、抽卡/升级/挂机的钻石经济现在都是粗拍的。需要调到"连续玩 20 分钟有正反馈、会卡关但升级/抽卡后能过"。这是离 MVP 达标的最后一公里。
2. **真美术** — SVG 占位 → AI 立绘;手写 Lottie → LottieFiles 免费特效。
3. **可选增强** — 装备、技能多样化、章节 BOSS、新手引导。
...
│  ├─ economy.ts + economy.test.ts            挂机产钻 + 养成成长/花费(纯函数 + 单测)
